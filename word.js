...
//  Set the page size and add the image to the header
    pdfdoc.addImage('bmu.jpg', 'JPEG', 150, 10, 40, 40);
    ...
    pdfdoc.text("Post applied: "+nam.postappplied,20,50);
    pdfdoc.text("School/Department: "+nam.schoolapplied,20,60);
    pdfdoc.text("Name: "+sName,20,70);
    pdfdoc.text("Marital Status: "+nam.marital,20,80);
    pdfdoc.text("Gender: "+nam.gender,20,90,);
    pdfdoc.text("Date of Birth: "+nam.dob,20,100);
